...
| 0x8001CBA8 | ORPHAN | `ov_8001CBA8` | engine/native_path.cpp:266 |  | write a {0,252,0,255} 4-byte pattern at offsets 72/74/76/78 of a0+(a1&… |
...
| 0x80044BD4 | LIVE | `native_area_load` | runtime/recomp/native_boot.cpp:616 | 0x80052010 | minus the async task-1 spawn + cross-frame yield-wait: kill the (unuse… |
...
| 0x80044F58 | LIVE | `native_cb_loadidx` | runtime/recomp/native_boot.cpp:541 | 0x80044E84 | the shared index/asset sub-loader (stage-0 callback, and called again … |
| 0x80045080 | ORPHAN | `ov_80045080` | engine/native_path_b3.cpp:25 | 0x8001DC40 | index the stride-8 table at 0x800BE118 by (a1 & 255); load its two wor… |
...
| 0x800450BC | LIVE | `native_load_overlay` | runtime/recomp/native_boot.cpp:467 |  | load the stage overlay (if any) and point the task's restart entry at … |
| 0x8004514C | LIVE | `native_cb_loadgame` | runtime/recomp/native_boot.cpp:590 |  | the stage-1 callback. Loads SWDATA.BIN + the DAT payload slice, runs t… |
...
| 0x800499E8 | LIVE | `native_task0_bootstrap` | runtime/recomp/native_boot.cpp:497 |  | resolve \BIN\START.BIN natively, record its {LBA,size}, switch task 0 … |
...
| 0x80050B08 | LIVE | `ov_game_main` | runtime/recomp/native_boot.cpp:429 | 0x80089860 |  |
| 0x80050B08 | LIVE | `ov_game_main` | runtime/recomp/native_boot.cpp:691 | 0x8001CC00 0x800499E8 0x800509B4 0x80050A0C 0x80050A80 0x80051E00 … |  |
| 0x80050B08 | LIVE | `native_boot_run` | runtime/recomp/native_boot.cpp:971 |  | Wired from boot.c when PSXPORT_NATIVE_BOOT is set. Registers the main … |
...
| 0x80051794 | ORPHAN | `ov_80051794` | engine/native_path.cpp:72 |  | init an 8-word block at a0 to {0x1000,0,0x1000,0,0x1000,0,0,0} (three … |
...
| 0x8006CBD0 | ORPHAN | `ov_8006CBD0` | engine/native_path.cpp:178 |  | scatter 6 u16 fields from a1 into the scratchpad block at 0x1F8000D0 (… |
| 0x8006D654 | ORPHAN | `ov_cam_pitch` | engine/engine_camera.cpp:569 |  | ──────────────────────────────────────────────────────────────────────… |
| 0x8006D934 | ORPHAN | `ov_8006D934` | engine/native_path.cpp:96 |  | *0x1F8000DC = *(a1+0); *0x1F8000E4 = *(a1+8) (scratchpad). |
| 0x8006D950 | ORPHAN | `ov_8006D950` | engine/native_path.cpp:93 |  | *0x1F8000E0 (scratchpad) = *(a1+4). |
...
| 0x800752B4 | ORPHAN | `ov_800752B4` | engine/native_path_a1.cpp:313 |  | ── 0x800752B4 — classify 24 entries into a priority byte at +8 of each… |
| 0x800753AC | ORPHAN | `ov_800753AC` | engine/native_path_b3.cpp:11 | 0x8001DC40 | a1 = *(0x800BE108) + a1, then tail-call 0x8001DC40(a0, a1). |
| 0x800753AC | LIVE | `native_build_vram` | runtime/recomp/native_boot.cpp:569 | 0x800753D4 0x80075448 | engine TIM/sprite VRAM build for the boot asset set. Its first action … |
| 0x800753D4 | ORPHAN | `ov_cel_load_wait` | engine/engine_level.cpp:177 | 0x80075410 0x80096480 0x80096980 |  |
| 0x800754F4 | LIVE | `native_build_vram` | runtime/recomp/native_boot.cpp:569 | 0x800753D4 0x80075448 | engine TIM/sprite VRAM build for the boot asset set. Its first action … |
| 0x80075E04 | ORPHAN | `ov_80075E04` | engine/native_path_a3.cpp:24 |  | register an entry in a 24-slot, stride-12 priority table and (if a slo… |
...
| 0x80077FB0 | ORPHAN | `ov_80077FB0` | engine/native_path_a3.cpp:311 |  | integer square root (16-bit binary-search refinement). a0 = input; the… |
| 0x800782F0 | ORPHAN | `ov_800782F0` | engine/native_path_a3.cpp:242 |  | set/queue a sound-bank request. a0 (low byte) selects a sub-bank (must… |
...
| 0x8007A12C | ORPHAN | `ov_8007A12C` | engine/native_path_a3.cpp:437 |  |  |
...
| 0x8007A810 | ORPHAN | `ov_8007A810` | engine/native_path_b2.cpp:59 | 0x8009A420 | init a 4-entry, stride-264 array at 0x80100690: zero a 388-byte header… |
| 0x8007A8E0 | ORPHAN | `ov_8007A8E0` | engine/native_path_b2.cpp:73 | 0x8007982C | call 0x8007982C (block init) then clear the scratchpad u16 at 0x1F8001… |
...
| 0x8007AC14 | ORPHAN | `ov_8007AC14` | engine/native_path_b1.cpp:29 | 0x8009A420 | AC40/AC6C/AC98/AD14 — memset(<global>, 0, <n>) via 0x8009A420. Bases f… |
| 0x8007AC40 | ORPHAN | `ov_8007AC40` | engine/native_path_b1.cpp:30 | 0x8009A420 |  |
| 0x8007AC6C | ORPHAN | `ov_8007AC6C` | engine/native_path_b1.cpp:31 | 0x8009A420 |  |
| 0x8007AC98 | ORPHAN | `ov_8007AC98` | engine/native_path_b1.cpp:32 | 0x8009A420 |  |
| 0x8007ACC4 | ORPHAN | `ov_8007ACC4` | engine/native_path_b1.cpp:36 | 0x8009A420 | 8× memset(0x80100400 + i*76, 0, 76) via 0x8009A420 (eight stride-76 re… |
| 0x8007AD14 | ORPHAN | `ov_8007AD14` | engine/native_path_b1.cpp:33 | 0x8009A420 |  |
| 0x8007AD40 | ORPHAN | `ov_8007AD40` | engine/native_path_b1.cpp:42 | 0x8009A420 | memset(0x800EC188, 0, 2560) via 0x8009A420, then for 40 stride-64 reco… |
| 0x8007B18C | ORPHAN | `ov_8007B18C` | engine/native_path_b4.cpp:13 | 0x8004FB20 0x800798F8 0x8007A810 0x8007AC14 0x8007AC40 0x8007AC6C … | top-level object-pool init. Calls 0x8004FB20 then 0x800798F8; zeroes 5… |
...
| 0x8007E9C8 | ORPHAN | `ov_8007E9C8` | engine/native_path_b3.cpp:151 | 0x80083DE0 | build a GPU primitive into a 12-word pool slot (pool head at 0x800BF54… |
...
| 0x80080880 | LIVE | `ov_switch` | runtime/recomp/native_boot.cpp:103 |  | ChangeThread override = the universal task-switch primitive. Every coo… |
| 0x80080880 | ORPHAN | `ov_change_thread` | runtime/recomp/threads.cpp:27 |  |  |
| 0x80080890 | ORPHAN | `ov_80080890` | engine/native_path.cpp:52 |  | EnterCriticalSection: `a0=1; syscall`. Routed through rec_syscall so t… |
...
| 0x80082220 | ORPHAN | `ov_80082220` | engine/native_path.cpp:111 |  | GPU draw-mode word: base 0xE1000000, \|512 if a1!=0, plus (a2&2559)\|102… |
| 0x80082240 | ORPHAN | `ov_80082240` | engine/native_path_a2.cpp:154 |  |  |
| 0x800822D8 | ORPHAN | `ov_800822D8` | engine/native_path_a2.cpp:155 |  |  |
| 0x80082370 | ORPHAN | `ov_80082370` | engine/native_path.cpp:108 |  | libgpu primitive/tpage word: 0xE5000000 \| ((a1&2047)<<11) \| (a0&2047). |
| 0x80082C68 | ORPHAN | `ov_80082C68` | engine/native_path.cpp:212 |  | write four GPU primitive templates through the pointer table at 0x800A… |
...
| 0x80084250 | ORPHAN | `ov_80084250` | engine/native_path_b2.cpp:101 |  | transform 3 vertices through a GTE matrix (5 ctrl regs from a0), three… |
| 0x80084360 | ORPHAN | `ov_compmatlv` | engine/engine_math.cpp:442 |  | ──────────────────────────────────────────────────────────────────────… |
| 0x80084470 | ORPHAN | `ov_80084470` | engine/native_path_b1.cpp:66 |  | GTE matrix×vector: load 5 ctrl regs from the matrix at a0, 2 data regs… |
...
| 0x80089788 | ORPHAN | `ov_80089788` | engine/native_path.cpp:21 |  |  |
| 0x80089B98 | ORPHAN | `ov_80089B98` | engine/native_path.cpp:102 |  | get/set the global word at 0x800ABFC0 (returns old, writes a0). |
| 0x80089BAC | ORPHAN | `ov_80089BAC` | engine/native_path_b3.cpp:59 | 0x8008AC34 | retry wrapper (up to 4 attempts) around 0x8008AC34. idx = a0 & 255. |
...
| 0x8008BBC8 | ORPHAN | `ov_8008BBC8` | engine/native_path_b1.cpp:19 | 0x8009A640 | strncmp(a0, a1, 12) via 0x8009A640; return 1 if equal (result < 1 unsi… |
| 0x8008BEAC | ORPHAN | `ov_8008BEAC` | engine/native_path_b2.cpp:11 | 0x8009A540 | search a 128-entry, stride-44 table at 0x80102D6C for an entry whose i… |
...
| 0x80092FD0 | ORPHAN | `ov_80092FD0` | engine/native_path_a3.cpp:104 |  | refresh the active "channel/voice" hardware-shadow tables from the two… |
...
| 0x80096370 | ORPHAN | `ov_80096370` | engine/native_path.cpp:87 |  | store (uint8_t)a0 to the global byte at 0x80105D28. |
| 0x80096390 | ORPHAN | `ov_80096390` | engine/native_path.cpp:90 |  | store u16 0 to the global at 0x80105CD8. |
| 0x800963A0 | LIVE | `ov_font_bank_select` | engine/engine_font.cpp:27 |  | font-bank selector. a0 = bank index. If ((a0-1)&0xff) < 24, store the … |
| 0x800963A0 | ORPHAN | `ov_800963A0` | engine/native_path.cpp:80 |  | bounded register: if ((a0-1)&0xff) < 24, store (uint8_t)a0 to the glob… |
| 0x80096590 | ORPHAN | `ov_bav_load` | engine/engine_bav.cpp:286 | 0x80096590 |  |
| 0x800974FC | ORPHAN | `ov_800974FC` | engine/native_path.cpp:204 |  | write into the u16 table at *0x800AC604, index a0: if a2==0 store a1, … |
| 0x80097540 | ORPHAN | `ov_80097540` | engine/native_path_a1.cpp:50 |  | ── 0x80097540 — sound/voice region-bound helper. If *0x800AC628 (=0x80… |
| 0x80097678 | ORPHAN | `ov_80097678` | engine/native_path.cpp:124 |  | read-modify-write the word at *0x800AC618: v = (v & 0xF0FFFFFF) \| 0x02… |
| 0x800976C8 | ORPHAN | `ov_800976C8` | engine/native_path.cpp:221 |  | original spins x=13; x*=13 sixty times into a stack local with NO exte… |
| 0x80097760 | ORPHAN | `ov_80097760` | engine/native_path.cpp:225 |  | if (int)a0 <= 0 return 0; else set up a request block at a1 and regist… |
| 0x800977C0 | ORPHAN | `ov_800977C0` | engine/native_path_b5.cpp:16 | 0x80097A90 | allocate a `size`-byte run from the block table at G_base (0x800AC66C)… |
...
| 0x80099450 | ORPHAN | `ov_80099450` | engine/native_path.cpp:130 |  | *0x800AC638 = (a0 == 1) ? 0 : 1. |
| 0x80099478 | ORPHAN | `ov_80099478` | engine/native_path.cpp:105 |  | return (*0x800AC638 ^ 1) != 0  (i.e. *0x800AC638 != 1). |
| 0x800998E4 | ORPHAN | `ov_800998E4` | engine/native_path_a2.cpp:286 |  | fill the 24-byte status array at a0 from two parallel 16-element bitma… |
| 0x8009A1D0 | ORPHAN | `ov_8009A1D0` | engine/native_path.cpp:118 |  | table read: entry = *0x800AC604 + (a0<<4); *(u16*)a1 = *(u16*)(entry+1… |
...
| 0x8010649C | LIVE | `ov_start_bin_stage` | runtime/recomp/native_boot.cpp:657 |  | Stage-0 START.BIN entry (0x8010649c): own the file-table BUILDER PC-na… |
