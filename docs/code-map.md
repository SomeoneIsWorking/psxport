...
| 0x8007778C | ORPHAN | `Cull::cullWrapper` | game/render/cull.cpp:333 | 0x8007712C | camera-relative cull WRAPPER. Computes obj-cam delta (wrapping s16, si… |
| 0x80077ACC | ORPHAN | `Cull::cullWrap77acc` | game/render/cull.cpp:350 | 0x8007712C | cull-wrapper variant, caller-supplied position in a1/a2/a3 (not obj fi… |
