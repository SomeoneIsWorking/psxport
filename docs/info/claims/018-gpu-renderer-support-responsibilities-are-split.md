...
GPU renderer support responsibilities are split into peer owners and both critical legacy caps are shrink-only at 4,051/4,288 lines
...
if gpu_native.cpp exceeds 4,051, gpu_vk.cpp exceeds 4,288, either extracted owner is bypassed/duplicated, or the full Clang CTest fails
