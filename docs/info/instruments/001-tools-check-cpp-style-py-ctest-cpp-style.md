...
Its hermetic --selftest passes 34/34: the clean fixture lints 1/1 TU and excludes a tracked
...
The reference scanner recognizes literal `STATIC_PRODUCT_MARKERS` and `RETIRED_TRACKED_PATHS` declarations independently
