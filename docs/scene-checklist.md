...
| 6 | Fisherman intro cutscene | after 5 | BUG #44 | 2026-07-14 checked f1130-1830: NO #35 darkening here (daytime segment; luminance tracks oracle within ~1pt — the f1520-1640 gap was the missing dialog box). Two render-side bugs (exec-swap isolated): **#44** Tomba sprite upside-down in the hooked-fish beat (~f1370); **#34** dialog text-box panel missing (also row 9) |
...
| 9 | Dialog / signpost text | field, `press up`+O at sign | BUG #34 | text box PANEL missing — bare text on field |
