...
| build-file assertions | 12 required strings present in cmake/`gen_gpu_shaders.py`/tests/`emit.py`/`port_gen.py` afterwards — a rule that became a no-op upstream **fails** | — |
