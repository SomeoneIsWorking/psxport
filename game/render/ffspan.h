...
// engine_stage.cpp.) Reached as `c->game->ffspan.<...>`; back-pointer `core` wired in Game's ctor.
#pragma once
#include <stdint.h>
#include "pkt_span.h"
class Core;
...
public:
  ...
  // Record one closed span (used by end() and the FFS macro in engine_stage.cpp).
