 ...
 S0:
  ...
  switch (n3) {
    ...
    case 3: case 4: {                               // jt0 -> 0x8012dab8
      (c->r[4]=s0, c->r[5]=12, c->r[6]=79, c->engine.graphicsBind.recordInit());            // FUN_80051B70(node, 12, 79)
      if (c->r[2] != 0) goto Lret;
      uint32_t rec = c->mem_r32(s0 + 0xC0);         // node[0xC0]
      c->mem_w16(rec + 8, (uint16_t)(n3 == 3 ? 182 : (uint16_t)(int16_t)-182));
      c->r[4] = s0; c->engine.graphicsBind.renderUpdate();                    // FUN_800517F8(node)
      goto Lret;
    }
    case 5:                                         // jt0 -> 0x8012db08
      (c->r[4]=s0, c->r[5]=12, c->r[6]=7, c->engine.graphicsBind.recordInit());             // FUN_80051B70(node, 12, 7)
      if (c->r[2] != 0) goto Lret;
      c->r[4] = s0; c->engine.graphicsBind.renderUpdate();                    // FUN_800517F8(node)
      goto Lret;
  }
  ...
  switch (n3) {
    case 0: {                                       // jt1 -> 0x8012db60
      ...
      if (s1 == 0) {                                // 0x8012db88
        ...
        (c->r[4]=s0, c->r[5]=A1_MODEL, c->r[6]=15, c->engine.graphicsBind.setGeom());    // FUN_80077B38(node, 0x8014C808, 15)
      ...
      if (s1 == 1) {                                // 0x8012dbd8
        ...
        c->engine.graphicsBind.posCompose();                      // FUN_8004BD64(node,2,*0x800E7F5C,*0x800E7F50,&node[0x60])
    ...
    case 2: {                                       // jt1 -> 0x8012dc20
      ...
      if (s1 == 0) {                                // 0x8012dc40
        ...
        (c->r[4]=s0, c->r[5]=A1_MODEL, c->r[6]=2, c->engine.graphicsBind.setGeom());     // FUN_80077B38(node, 0x8014C808, 2)
      ...
      c->mem_w32(c->r[29] + 16, s0 + 0x60); c->engine.graphicsBind.posCompose();   // FUN_8004BD64 — native
    ...
    case 6: {                                       // jt1 -> 0x8012dcb0
      ...
      if (s1 == 0) {                                // 0x8012dcd0
        c->mem_w8(s0 + 5, 1);
        c->mem_w32(s0 + 0x3C, c->mem_r32(0x800ECF80u));
        (c->r[4]=s0, c->r[5]=A1_MODEL, c->r[6]=17, c->engine.graphicsBind.setGeom());    // FUN_80077B38(node, 0x8014C808, 17)
    ...
    case 7: {                                       // jt1 -> 0x8012dd4c
      ...
      if (s1 == 0) {                                // 0x8012dd6c
        c->mem_w8(s0 + 5, 1);
        c->mem_w32(s0 + 0x3C, c->mem_r32(0x800ECF80u));
        (c->r[4]=s0, c->r[5]=A1_MODEL, c->r[6]=14, c->engine.graphicsBind.setGeom());    // FUN_80077B38(node, 0x8014C808, 14)
        c->mem_w16(s0 + 0x60, (uint16_t)(int16_t)-200);
