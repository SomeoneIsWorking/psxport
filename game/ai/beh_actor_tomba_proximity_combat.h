...
// convention — calling rec_dispatch on an address EngineOverrides registers reaches the native
// automatically once wired; this draft does not itself call the C++ methods directly):
