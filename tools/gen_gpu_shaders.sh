...
# uint32_t arrays in a generated header (runtime/recomp/gpu_vk_shaders.h), so gpu_vk.cpp has no runtime
...
# Called by run.sh / tools/build_port.sh before compiling gpu_vk.cpp. Idempotent. Requires glslc.
set -eu
cd "$(dirname "$0")/.."
...
{
  echo "// GENERATED by tools/gen_gpu_shaders.sh — do not edit. SPIR-V for the SDL_GPU renderer (gpu_vk.cpp)."
