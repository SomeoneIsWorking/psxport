...
static void walk(const std::string &abs, const std::string &rel, Scan &sc) {
  ...
  while ((e = readdir(d)) != nullptr) {
    ...
    const std::string a = path_join(abs, name), r = rel.empty() ? name : path_join(rel, name);
    struct stat st;
  ...
  for (const std::string &s : subdirs) {
    walk(path_join(abs, s), rel.empty() ? s : path_join(rel, s), sc);
  }
}
...
static const BaselineRow kBaseline[] = {
    {"runtime/recomp/cd_override.cpp", 0x1f800137u, 1},  {"runtime/recomp/cd_override.cpp", 0x1f800138u, 1},
    {"runtime/recomp/cd_override.cpp", 0x1f80019au, 1},  {"runtime/recomp/cd_override.cpp", 0x1f8001f0u, 2},
    {"runtime/recomp/cd_override.cpp", 0x1f8001f4u, 3},  {"runtime/recomp/cd_override.cpp", 0x1f8001f8u, 3},
    {"runtime/recomp/cd_override.cpp", 0x8001cf00u, 2},  {"runtime/recomp/cd_override.cpp", 0x800be220u, 1},
    {"runtime/recomp/cd_override.cpp", 0x800be222u, 1},  {"runtime/recomp/cd_override.cpp", 0x800be224u, 1},
    {"runtime/recomp/cd_override.cpp", 0x800bed80u, 1},  {"runtime/recomp/cd_override.cpp", 0x801fe0e0u, 3},
    {"runtime/recomp/dbg_server.cpp", 0x800be258u, 1},   {"runtime/recomp/dbg_server.cpp", 0x800ecf58u, 1},
    {"runtime/recomp/dbg_server.cpp", 0x800f2624u, 1},   {"runtime/recomp/dbg_server.cpp", 0x800fb168u, 1},
    {"runtime/recomp/dbg_server.cpp", 0x801fe00cu, 1},   {"runtime/recomp/dbg_server.cpp", 0x801fe048u, 1},
    {"runtime/recomp/dualcore.cpp", 0x1f800137u, 1},     {"runtime/recomp/dualcore.cpp", 0x800b0000u, 1},
    {"runtime/recomp/dualcore.cpp", 0x80110000u, 1},     {"runtime/recomp/gpu_native.cpp", 0x800bf544u, 1},
    {"runtime/recomp/gpu_native.cpp", 0x801fe00cu, 2},   {"runtime/recomp/gpu_vk.cpp", 0x1f800138u, 1},
    {"runtime/recomp/gpu_vk.cpp", 0x80100400u, 4},       {"runtime/recomp/hle.cpp", 0x1f800138u, 1},
    {"runtime/recomp/hle.cpp", 0x1f80019bu, 1},          {"runtime/recomp/hle.cpp", 0x1f800234u, 1},
    {"runtime/recomp/hle.cpp", 0x800bf870u, 1},          {"runtime/recomp/hle.cpp", 0x80108f9cu, 1},
    {"runtime/recomp/hle.cpp", 0x80109450u, 1},          {"runtime/recomp/hle.cpp", 0x8018a000u, 1},
    {"runtime/recomp/hle.cpp", 0x801fe00cu, 1},          {"runtime/recomp/interp.cpp", 0x1f80019au, 1},
    {"runtime/recomp/interp.cpp", 0x1f8001f0u, 1},       {"runtime/recomp/interp.cpp", 0x1f8001f4u, 1},
    {"runtime/recomp/interp.cpp", 0x1f8001f8u, 1},       {"runtime/recomp/interp.cpp", 0x80026874u, 2},
    {"runtime/recomp/interp.cpp", 0x80052208u, 2},       {"runtime/recomp/interp.cpp", 0x800522b0u, 2},
    {"runtime/recomp/interp.cpp", 0x80074bf8u, 1},       {"runtime/recomp/interp.cpp", 0x80074e48u, 2},
    {"runtime/recomp/interp.cpp", 0x80075834u, 2},       {"runtime/recomp/interp.cpp", 0x800788ccu, 1},
    {"runtime/recomp/interp.cpp", 0x8007e998u, 1},       {"runtime/recomp/interp.cpp", 0x8007e9c8u, 1},
    {"runtime/recomp/interp.cpp", 0x8008e390u, 1},       {"runtime/recomp/interp.cpp", 0x80090210u, 1},
    {"runtime/recomp/interp.cpp", 0x80090560u, 1},       {"runtime/recomp/interp.cpp", 0x800909c0u, 3},
    {"runtime/recomp/interp.cpp", 0x80090bd0u, 3},       {"runtime/recomp/interp.cpp", 0x80091460u, 1},
    {"runtime/recomp/interp.cpp", 0x800914d0u, 1},       {"runtime/recomp/interp.cpp", 0x800939a0u, 1},
    {"runtime/recomp/interp.cpp", 0x800be0e4u, 1},       {"runtime/recomp/interp.cpp", 0x80104c30u, 1},
    {"runtime/recomp/interp.cpp", 0x801fe00cu, 1},       {"runtime/recomp/interp.cpp", 0x801fe134u, 1},
    {"runtime/recomp/interp.cpp", 0x801fe138u, 1},       {"runtime/recomp/interp.cpp", 0x801fe146u, 1},
    {"runtime/recomp/mem.cpp", 0x8009a420u, 1},          {"runtime/recomp/mem.cpp", 0x801fe00cu, 2},
    {"runtime/recomp/native_boot.cpp", 0x1f8000d2u, 2},  {"runtime/recomp/native_boot.cpp", 0x1f8000d6u, 2},
    {"runtime/recomp/native_boot.cpp", 0x1f8000dau, 2},  {"runtime/recomp/native_boot.cpp", 0x1f800135u, 1},
    {"runtime/recomp/native_boot.cpp", 0x1f800137u, 1},  {"runtime/recomp/native_boot.cpp", 0x1f80019cu, 1},
    {"runtime/recomp/native_boot.cpp", 0x1f8001f0u, 1},  {"runtime/recomp/native_boot.cpp", 0x1f8001f4u, 1},
    {"runtime/recomp/native_boot.cpp", 0x1f8001f8u, 1},  {"runtime/recomp/native_boot.cpp", 0x1f800224u, 1},
    {"runtime/recomp/native_boot.cpp", 0x800ac424u, 1},  {"runtime/recomp/native_boot.cpp", 0x800ac42cu, 1},
    {"runtime/recomp/native_boot.cpp", 0x800be0e4u, 1},  {"runtime/recomp/native_boot.cpp", 0x800be3d8u, 1},
    {"runtime/recomp/native_boot.cpp", 0x80104c28u, 2},  {"runtime/recomp/native_boot.cpp", 0x801054b0u, 2},
    {"runtime/recomp/native_boot.cpp", 0x80108000u, 1},  {"runtime/recomp/native_boot.cpp", 0x80109450u, 1},
    {"runtime/recomp/native_boot.cpp", 0x801fe000u, 3},  {"runtime/recomp/native_boot.cpp", 0x801fe00cu, 1},
    {"runtime/recomp/native_boot.cpp", 0x801fe0e0u, 1},  {"runtime/recomp/native_boot.cpp", 0x801fe0ecu, 1},
    {"runtime/recomp/native_boot.cpp", 0x801fe134u, 1},  {"runtime/recomp/native_boot.cpp", 0x801fe138u, 1},
    {"runtime/recomp/native_boot.cpp", 0x801fe146u, 1},  {"runtime/recomp/overlay_glue.cpp", 0x1f8000d2u, 1},
    {"runtime/recomp/overlay_glue.cpp", 0x1f8000d6u, 1}, {"runtime/recomp/overlay_glue.cpp", 0x1f8000dau, 1},
    {"runtime/recomp/overlay_glue.cpp", 0x801fe00cu, 1}, {"runtime/recomp/overlay_router.cpp", 0x801fe00cu, 1},
    {"runtime/recomp/pad_input.cpp", 0x1f800138u, 1},    {"runtime/recomp/pad_input.cpp", 0x1f800236u, 1},
    {"runtime/recomp/pad_input.cpp", 0x800be258u, 1},    {"runtime/recomp/pad_input.cpp", 0x800bf809u, 1},
    {"runtime/recomp/pad_input.cpp", 0x800bf80fu, 1},    {"runtime/recomp/pad_input.cpp", 0x800bf839u, 1},
    {"runtime/recomp/pad_input.cpp", 0x800bf870u, 1},    {"runtime/recomp/pad_input.cpp", 0x800bf89cu, 1},
    {"runtime/recomp/pad_input.cpp", 0x800e7e68u, 1},    {"runtime/recomp/pad_input.cpp", 0x800fe916u, 1},
    {"runtime/recomp/pad_input.cpp", 0x800fe91eu, 1},    {"runtime/recomp/pc_scheduler.cpp", 0x1f800138u, 1},
    {"runtime/recomp/pc_scheduler.cpp", 0x80044bd4u, 1}, {"runtime/recomp/pc_scheduler.cpp", 0x80051f14u, 1},
    {"runtime/recomp/pc_scheduler.cpp", 0x80051f40u, 1}, {"runtime/recomp/pc_scheduler.cpp", 0x80051f54u, 1},
    {"runtime/recomp/pc_scheduler.cpp", 0x80051f68u, 1}, {"runtime/recomp/pc_scheduler.cpp", 0x80051f70u, 1},
    {"runtime/recomp/pc_scheduler.cpp", 0x80051f80u, 1}, {"runtime/recomp/pc_scheduler.cpp", 0x80051fa4u, 1},
    {"runtime/recomp/pc_scheduler.cpp", 0x80051fb4u, 1}, {"runtime/recomp/pc_scheduler.cpp", 0x80051fdcu, 1},
    {"runtime/recomp/pc_scheduler.cpp", 0x80051ff0u, 1}, {"runtime/recomp/pc_scheduler.cpp", 0x80051ff8u, 1},
    {"runtime/recomp/pc_scheduler.cpp", 0x80052000u, 1}, {"runtime/recomp/pc_scheduler.cpp", 0x80052010u, 1},
    {"runtime/recomp/pc_scheduler.cpp", 0x80052054u, 1}, {"runtime/recomp/pc_scheduler.cpp", 0x80052060u, 1},
    {"runtime/recomp/pc_scheduler.cpp", 0x80052068u, 1}, {"runtime/recomp/pc_scheduler.cpp", 0x80080860u, 1},
    {"runtime/recomp/pc_scheduler.cpp", 0x80080870u, 2}, {"runtime/recomp/pc_scheduler.cpp", 0x80080890u, 3},
    {"runtime/recomp/pc_scheduler.cpp", 0x800808a0u, 3}, {"runtime/recomp/pc_scheduler.cpp", 0x801062e4u, 4},
    {"runtime/recomp/pc_scheduler.cpp", 0x8010637cu, 3}, {"runtime/recomp/pc_scheduler.cpp", 0x801063f4u, 1},
    {"runtime/recomp/pc_scheduler.cpp", 0x8010649cu, 2}, {"runtime/recomp/pc_scheduler.cpp", 0x80109164u, 1},
    {"runtime/recomp/render_node.h", 0x1f80028cu, 1},    {"runtime/recomp/render_queue.cpp", 0x800f2624u, 1},
    {"runtime/recomp/render_queue.cpp", 0x800f2738u, 1}, {"runtime/recomp/render_queue.cpp", 0x800fb168u, 1},
    {"runtime/recomp/repl.cpp", 0x800ac424u, 1},         {"runtime/recomp/repl.cpp", 0x800ac42cu, 1},
    {"runtime/recomp/repl.cpp", 0x800e7eacu, 1},         {"runtime/recomp/repl.cpp", 0x800e7eb4u, 1},
    {"runtime/recomp/repl.cpp", 0x800f2624u, 1},         {"runtime/recomp/repl.cpp", 0x800f2738u, 1},
    {"runtime/recomp/repl.cpp", 0x800fb168u, 1},         {"runtime/recomp/repl.cpp", 0x80104c28u, 1},
    {"runtime/recomp/repl.cpp", 0x801054b0u, 1},         {"runtime/recomp/repl.cpp", 0x8010637cu, 1},
    {"runtime/recomp/repl.cpp", 0x801fe00cu, 4},         {"runtime/recomp/repl.cpp", 0x801fe048u, 1},
    {"runtime/recomp/sbs.cpp", 0x1f800008u, 1},          {"runtime/recomp/sbs.cpp", 0x1f800010u, 1},
    {"runtime/recomp/sbs.cpp", 0x1f8000d2u, 2},          {"runtime/recomp/sbs.cpp", 0x1f8000d6u, 2},
    {"runtime/recomp/sbs.cpp", 0x1f8000dau, 2},          {"runtime/recomp/sbs.cpp", 0x1f8000e8u, 2},
    {"runtime/recomp/sbs.cpp", 0x1f8000eau, 2},          {"runtime/recomp/sbs.cpp", 0x1f8000ecu, 1},
    {"runtime/recomp/sbs.cpp", 0x1f800100u, 1},          {"runtime/recomp/sbs.cpp", 0x1f800134u, 1},
    {"runtime/recomp/sbs.cpp", 0x1f800137u, 4},          {"runtime/recomp/sbs.cpp", 0x1f800138u, 2},
    {"runtime/recomp/sbs.cpp", 0x1f80017cu, 1},          {"runtime/recomp/sbs.cpp", 0x1f80019bu, 3},
    {"runtime/recomp/sbs.cpp", 0x1f8001f0u, 1},          {"runtime/recomp/sbs.cpp", 0x1f8001fcu, 1},
    {"runtime/recomp/sbs.cpp", 0x1f800200u, 1},          {"runtime/recomp/sbs.cpp", 0x800a4d18u, 2},
    {"runtime/recomp/sbs.cpp", 0x800a4ef8u, 6},          {"runtime/recomp/sbs.cpp", 0x800a4f7eu, 1},
    {"runtime/recomp/sbs.cpp", 0x800a4f80u, 2},          {"runtime/recomp/sbs.cpp", 0x800a5000u, 1},
    {"runtime/recomp/sbs.cpp", 0x800abde0u, 1},          {"runtime/recomp/sbs.cpp", 0x800ac000u, 1},
    {"runtime/recomp/sbs.cpp", 0x800ac5f8u, 2},          {"runtime/recomp/sbs.cpp", 0x800ac700u, 1},
    {"runtime/recomp/sbs.cpp", 0x800ac800u, 1},          {"runtime/recomp/sbs.cpp", 0x800be000u, 1},
    {"runtime/recomp/sbs.cpp", 0x800be0e0u, 1},          {"runtime/recomp/sbs.cpp", 0x800be0e4u, 1},
    {"runtime/recomp/sbs.cpp", 0x800be0f0u, 1},          {"runtime/recomp/sbs.cpp", 0x800be110u, 1},
    {"runtime/recomp/sbs.cpp", 0x800be1f8u, 1},          {"runtime/recomp/sbs.cpp", 0x800be238u, 2},
    {"runtime/recomp/sbs.cpp", 0x800be258u, 1},          {"runtime/recomp/sbs.cpp", 0x800be358u, 1},
    {"runtime/recomp/sbs.cpp", 0x800be3b8u, 1},          {"runtime/recomp/sbs.cpp", 0x800be3f8u, 1},
    {"runtime/recomp/sbs.cpp", 0x800bed78u, 1},          {"runtime/recomp/sbs.cpp", 0x800bed80u, 1},
    {"runtime/recomp/sbs.cpp", 0x800bed84u, 1},          {"runtime/recomp/sbs.cpp", 0x800bed88u, 1},
    {"runtime/recomp/sbs.cpp", 0x800bf000u, 1},          {"runtime/recomp/sbs.cpp", 0x800bf800u, 1},
    {"runtime/recomp/sbs.cpp", 0x800bf870u, 2},          {"runtime/recomp/sbs.cpp", 0x800bf873u, 1},
    {"runtime/recomp/sbs.cpp", 0x800bf89cu, 1},          {"runtime/recomp/sbs.cpp", 0x800bf900u, 1},
    {"runtime/recomp/sbs.cpp", 0x800bf9b4u, 2},          {"runtime/recomp/sbs.cpp", 0x800bf9b5u, 1},
    {"runtime/recomp/sbs.cpp", 0x800bfa13u, 1},          {"runtime/recomp/sbs.cpp", 0x800e0000u, 1},
    {"runtime/recomp/sbs.cpp", 0x800e7de0u, 1},          {"runtime/recomp/sbs.cpp", 0x800e7e74u, 1},
    {"runtime/recomp/sbs.cpp", 0x800e7e80u, 1},          {"runtime/recomp/sbs.cpp", 0x800e7eacu, 1},
    {"runtime/recomp/sbs.cpp", 0x800ecf54u, 1},          {"runtime/recomp/sbs.cpp", 0x800ecf80u, 1},
    {"runtime/recomp/sbs.cpp", 0x800ecfd4u, 1},          {"runtime/recomp/sbs.cpp", 0x800ed000u, 1},
    {"runtime/recomp/sbs.cpp", 0x800ed020u, 1},          {"runtime/recomp/sbs.cpp", 0x800ed098u, 7},
    {"runtime/recomp/sbs.cpp", 0x800ed09cu, 2},          {"runtime/recomp/sbs.cpp", 0x800ee480u, 1},
    {"runtime/recomp/sbs.cpp", 0x800ef478u, 1},          {"runtime/recomp/sbs.cpp", 0x800ef500u, 1},
    {"runtime/recomp/sbs.cpp", 0x800f2624u, 1},          {"runtime/recomp/sbs.cpp", 0x800f2738u, 1},
    {"runtime/recomp/sbs.cpp", 0x800fb165u, 2},          {"runtime/recomp/sbs.cpp", 0x800fb166u, 1},
    {"runtime/recomp/sbs.cpp", 0x800fb168u, 1},          {"runtime/recomp/sbs.cpp", 0x801054ceu, 1},
    {"runtime/recomp/sbs.cpp", 0x80105c10u, 1},          {"runtime/recomp/sbs.cpp", 0x80105ca0u, 1},
    {"runtime/recomp/sbs.cpp", 0x80105d00u, 1},          {"runtime/recomp/sbs.cpp", 0x80105ee8u, 3},
    {"runtime/recomp/sbs.cpp", 0x80105eecu, 1},          {"runtime/recomp/sbs.cpp", 0x80105f00u, 1},
    {"runtime/recomp/sbs.cpp", 0x80157000u, 1},          {"runtime/recomp/sbs.cpp", 0x8017d000u, 1},
    {"runtime/recomp/sbs.cpp", 0x801fe150u, 1},          {"runtime/recomp/sbs.cpp", 0x801ff200u, 1},
    {"runtime/recomp/scheduler.cpp", 0x8010637cu, 1},    {"runtime/recomp/scheduler.cpp", 0x801063f4u, 2},
    {"runtime/recomp/scheduler.cpp", 0x801fe0e0u, 1},    {"runtime/recomp/scheduler.h", 0x1f800138u, 1},
    {"runtime/recomp/scheduler.h", 0x801fe000u, 1},      {"runtime/recomp/selftest.cpp", 0x1f800198u, 11},
    {"runtime/recomp/selftest.cpp", 0x800b0000u, 3},     {"runtime/recomp/selftest.cpp", 0x800bf870u, 2},
    {"runtime/recomp/selftest.cpp", 0x800bf9b4u, 7},     {"runtime/recomp/selftest.cpp", 0x801026e0u, 1},
    {"runtime/recomp/selftest.cpp", 0x80104c00u, 1},     {"runtime/recomp/selftest.cpp", 0x80109450u, 5},
    {"runtime/recomp/selftest.cpp", 0x80110000u, 1},     {"runtime/recomp/selftest.cpp", 0x801138a4u, 3},
    {"runtime/recomp/selftest.cpp", 0x801fe048u, 4},     {"runtime/recomp/timing.cpp", 0x800abde0u, 1},
