...
static void test_every_named_source_bit_latches(void) {
  const int bits[] = { IRQ_BIT_VBLANK, IRQ_BIT_GPU, IRQ_BIT_CD, IRQ_BIT_DMA, IRQ_BIT_TIMER0,
                       IRQ_BIT_TIMER1, IRQ_BIT_TIMER2, IRQ_BIT_SIO, IRQ_BIT_SPU, IRQ_BIT_PIO };
  int scanned = 0;
