...
CXX="${CXX:-c++}"   # the RmlUi mod/debug overlay (rmlui_overlay.cpp + rmlui_render_vk.cpp + vendored
...
SRC="$RT/dispatch.cpp \
  ...
  $RT/disc.c $RT/cd_override.cpp $RT/cdc_native.c $RT/xa_stream.c $RT/timing.cpp $RT/gpu_vk.cpp $RT/gpu_perf.cpp $RT/mods.c $ENG/game_tomba2.cpp $ENG/asset.cpp $ENG/mathlib.cpp $ENG/cull.cpp $ENG/collision.cpp $ENG/hitbox.cpp $ENG/grid_offset.cpp game/world/spawn.cpp game/world/placement.cpp game/world/graphics_bind.cpp game/world/verify_gate.cpp game/world/pool.cpp game/world/entity.cpp game/render/render_native.cpp game/render/scene/scene_build.cpp game/render/mesh/mesh_draw.cpp $ENG/actor_sm_24448.cpp $ENG/objbeh_739ac.cpp $ENG/objbeh_73cd8.cpp $ENG/objbeh_741dc.cpp $ENG/objbeh_8012eb54.cpp $ENG/objbeh_80124e74.cpp $ENG/objbeh_80133c14.cpp $ENG/objbeh_80138fc8.cpp $ENG/objbeh_8013259c.cpp $ENG/objbeh_80145230.cpp $ENG/objbeh_8012d4ec.cpp $ENG/objbeh_8012d404.cpp $ENG/objbeh_801395c0.cpp $ENG/objbeh_8004c238.cpp $ENG/objbeh_8004ce14.cpp $ENG/objbeh_80071a3c.cpp $ENG/objbeh_8006f2d0.cpp $ENG/objbeh_8013c538.cpp $ENG/objbeh_8013c3f4.cpp $ENG/objbeh_8013c9c0.cpp $ENG/objbeh_80136d9c.cpp $ENG/objbeh_80129c00.cpp $ENG/objbeh_8012a0b8.cpp $ENG/objbeh_8012da04.cpp $ENG/objbeh_80121978.cpp $ENG/objbeh_80125e0c.cpp $ENG/objbeh_80128760.cpp $ENG/objbeh_80118240.cpp $ENG/objbeh_8013a900.cpp $ENG/objbeh_80117658.cpp $ENG/objbeh_80135d64.cpp $ENG/objbeh_8013b2e4.cpp $ENG/objbeh_80131d08.cpp $ENG/objbeh_80132400.cpp $ENG/objbeh_80133d6c.cpp $ENG/objbeh_80134fd8.cpp $ENG/objbeh_80136158.cpp $ENG/script.cpp $ENG/animation.cpp $ENG/input.cpp $ENG/menu.cpp $ENG/inventory.cpp $ENG/hud.cpp $ENG/lighting.cpp $ENG/engine_bav.cpp $ENG/save.cpp $ENG/sound.cpp $ENG/engine_init.cpp $ENG/engine_font.cpp $ENG/engine_level.cpp $ENG/fps60.cpp $ENG/engine_tomba2.cpp $ENG/engine_submit.cpp $ENG/engine_project.cpp $ENG/engine_render.cpp $ENG/engine_stage.cpp $ENG/sop.cpp $ENG/engine_demo.cpp $ENG/engine_camera.cpp $ENG/engine_math.cpp $ENG/engine_player.cpp $ENG/native_terrain.cpp $ENG/render_queue.cpp $ENG/clib.cpp $ENG/gte.cpp $ENG/gpu_lib.cpp $ENG/sound_voice.cpp $ENG/native_misc.cpp $RT/peripheral_misc.cpp $ENG/margin_render.cpp $ENG/audio/native_audio.c $ENG/audio/native_music.c $ENG/audio/music_list.c $RT/sync_overrides.cpp $RT/native_boot.cpp $RT/dbg_server.cpp $RT/native_stub.cpp $RT/watchdog.c $RT/dualcore.cpp $RT/sbs.cpp $RT/boot.cpp \
