...
SRC="$RT/dispatch.c \
  ...
  $RT/disc.c $RT/cd_override.c $RT/cdc_native.c $RT/xa_stream.c $RT/timing.c $RT/gpu_vk.c $RT/mods.c $ENG/game_tomba2.c $ENG/fps60.c $ENG/engine_tomba2.c $ENG/engine_submit.c $ENG/native_dl.c $RT/sync_overrides.c $RT/native_boot.c $RT/dbg_server.c $RT/native_stub.c $RT/watchdog.c $RT/boot.c \
