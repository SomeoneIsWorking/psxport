...
void watchdog_progress(void);              // forward progress; retain the current boot/steady timeout phase
void watchdog_main_present_complete(void); // main presenter complete: leave boot grace and start steady timing
