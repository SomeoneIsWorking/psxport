...
// Guest task-slot stanzas, called when no native stanza claims the slot. Each returns one when it
// processed the tick and zero to fall through.
...
// guest ABI does: base+0x0C = entry_pc, base+0x10 = caller's gp (r28), base+0x00 = 2 (RUNNABLE),
