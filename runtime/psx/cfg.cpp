...
// selection rule — a game declaring its enhancements as its own CVars reaches the same rule through
// psx::config::enh(). Two copies of enhancement selection would be
