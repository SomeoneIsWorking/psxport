...
static void ov_sync_ok(R3000* c) { c->r[V0] = 0; }   // 0 = sync complete, success
...
static void ov_cdreadsync(R3000* c) { zero_result(c->r[A1]); c->r[V0] = 0; }
...
static void ov_cddatasync(R3000* c) { c->r[V0] = 0; }   // 0 = DMA idle / transfer complete
