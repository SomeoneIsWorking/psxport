// Sony BIOS libc string leaves. Every byte travels through Core's guest-memory map: guest addresses
// are not host pointers, and KSEG0/KSEG1 aliases must retain the console's copy order.
