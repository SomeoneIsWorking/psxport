...
// the private marker caught here, so the generated guest call stack is discarded without masking
...
// B0:0x17. This is deliberately non-returning: returning to generated C resumes after the BIOS call
// and can execute one-time interrupt initialization as though the exception bootstrap were ordinary.
