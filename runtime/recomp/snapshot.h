...
//
// WHY. The recomp-MISS dump (hle.cpp) proved that a 2 MB image of guest RAM is the fastest way to
...
// 0x80000000 (external/psxport/tools/decomp.sh) or point tools/whatis.py --ram at it.
//
