...
public:
  ...
  void  setGeomOffset(float ofx, float ofy) { mGeomOfx = ofx; mGeomOfy = ofy; mGeomOffsetSet = true; }
  void  setGeomScreen(float h)              { mGeomH = h; mGeomScreenSet = true; }
  ...
  void  setGeomOfxForAspect(float ofx)      { mGeomOfx = ofx; }
  bool  geomValid() const                   { return mGeomOffsetSet && mGeomScreenSet; }
  float geomOfx() const                     { return mGeomOfx; }
  float geomOfy() const                     { return mGeomOfy; }
  float geomH()   const                     { return mGeomH; }
